...
# 세션 초기화를 위한 키
if 'listening_quiz_session_init' not in st.session_state:
    st.session_state.listening_quiz_session_init = False

# 새 세션 시작 시 초기화
if not st.session_state.listening_quiz_session_init:
    ...
    st.session_state.listening_quiz_session_init = True
